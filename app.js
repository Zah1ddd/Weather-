...
// const celsi = document.querySelector('.celsi')
// const overcast = document.querySelector('.overcast')
// const feel = document.querySelector('.fe-value')
// const wind = document.querySelector('.wi-value')
// const humid = document.querySelector('.hu-value')
// const uv = document.querySelector('.u-value')
// const visibility = document.querySelector('.vi-value')
// const pressure = document.querySelector('.press-value')
...
// const config = {
//   URL: "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/Azerbaijan?unitGroup=metric&key=R86R7M9PSE99C94M3BGPWBDE5&contentType=json"
// }
...
//     inputSearch.value=data.country
//     city.textContent = data.address
//     celsi.textContent = data.temp
//     overcast.textContent = data.description
//     feel.textContent = data.feels_like
//     wind.textContent = data.speed
//     humid.textContent = data.humidity
//     uv.textContent = data.type
